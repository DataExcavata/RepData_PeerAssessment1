...
A total of `r missingValuesTotal` exist in the dataset.

### 2. & 3. The strategy for filling in missing values in the dataset.  Loop through a copy of the dataset
### looking for missing step values.  When found, replace the missing step value with the average number of
### steps for the matching interval.
```{r}
